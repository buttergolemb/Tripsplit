import svgPaths from "./svg-0j20w86mgd";
  ...
  return (
    <div className="flex-[245.92_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-0 not-italic text-[#1c1c1e] text-[14px] top-[-0.37px] whitespace-nowrap">You</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="bg-[#f7f7f5] h-[339.989px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[15.997px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9972 15.9972">
        <g clipPath="url(#clip0_2093_986)" id="Icon">
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[15.997px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9972 15.9972">
        <g clipPath="url(#clip0_2093_980)" id="Icon">
