import svgPaths from "./svg-qp4iyuba6r";
...
function Button1() {
  return (
    <div className="bg-[#f7f7f5] h-[53px] relative rounded-[14px] shrink-0 w-full" data-name="Button">
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[15.997px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9972 15.9972">
        <g clipPath="url(#clip0_2093_1041)" id="Icon">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[15.997px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9972 15.9972">
        <g clipPath="url(#clip0_2093_1035)" id="Icon">
          <path d={svgPaths.p3a1b6dc0} id="Vector" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3331" />
          <path d={svgPaths.p34c51f80} id="Vector_2" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3331" />
          <path d={svgPaths.p58e8380} id="Vector_3" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3331" />
          <path d={svgPaths.pdebe0c0} id="Vector_4" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3331" />
        </g>
        <defs>
          <clipPath id="clip0_2093_1035">
            <rect fill="white" height="15.9972" width="15.9972" />
          </clipPath>
        </defs>
      </svg>
...
function Text1() {
  return (
    <div className="h-[19.495px] relative shrink-0 w-[95.983px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-[48px] not-italic text-[#007aff] text-[13px] text-center top-[0.63px] whitespace-nowrap">Split 4 of 6</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#eaf2ff] flex-[172.93_0_0] h-[43.472px] min-w-px relative rounded-[14px]" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7.992px] items-center pl-[13.993px] relative size-full">
          <Icon2 />
          <Text1 />
  ...
  return (
    <div className="relative shrink-0 size-[13.993px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9927 13.9927">
        <g clipPath="url(#clip0_2093_1023)" id="Icon">
          <path d={svgPaths.p1afdf900} id="Vector" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16606" />
          <path d={svgPaths.p37f22200} id="Vector_2" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16606" />
          <path d={svgPaths.p21155a80} id="Vector_3" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16606" />
          <path d={svgPaths.p1583a1c0} id="Vector_4" stroke="var(--stroke-0, #007AFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16606" />
        </g>
        <defs>
          <clipPath id="clip0_2093_1023">
...
function Container10() {
  return (
    <div className="bg-[rgba(0,122,255,0.1)] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[6.996px] pr-[7.009px] relative size-full">
        <Icon4 />
      </div>
    </div>
  );
...
function Text2() {
  return (
    <div className="flex-[245.92_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#1c1c1e] text-[14px] top-[-0.37px] whitespace-nowrap">Everyone</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="opacity-60 relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center size-full">
...
function Container11() {
  return (
    <div className="bg-[#007aff] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">S</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">You</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icon">
          <path d="M10 3L4.5 8.5L2 6" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.49854" />
        </g>
      </svg>
    </div>
  );
...
function Container12() {
  return (
    <div className="bg-[#007aff] relative rounded-[6px] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[3.996px] pr-[4px] py-[4px] relative size-full">
        <Icon5 />
      </div>
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[12px] relative size-full">
          <Container11 />
          <Text3 />
...
function Container13() {
  return (
    <div className="bg-[#34c759] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">M</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">Mike</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="bg-[#ff9f0a] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">A</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">Alex</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="bg-[#af52de] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">J</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">Jordan</p>
      </div>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="bg-[#ff6482] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">T</p>
      </div>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">Taylor</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="bg-[#5ac8fa] relative rounded-[27417100px] shrink-0 size-[27.998px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">C</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="flex-[273.905_0_0] h-[21.002px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#3c3c43] text-[14px] top-[-0.37px] whitespace-nowrap">Casey</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="bg-[#e5e5ea] relative rounded-[6px] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[3.996px] pr-[4px] py-[4px] relative size-full">
        <Icon10 />
      </div>
    </div>
...
function Button10() {
  return (
    <div className="bg-[rgba(255,255,255,0)] opacity-60 relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[12px] relative size-full">
          <Container21 />
          <Text8 />
...
function Container9() {
  return (
    <div className="bg-[#f7f7f5] relative rounded-[14px] shrink-0 w-full" data-name="Container">
